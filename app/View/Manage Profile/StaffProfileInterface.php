...
">Update</button>
    ...
    <script>
        ...
        updateButton.addEventListener("click", function() {
            ...
            var fullName = document.getElementById("Staff_Name").value;
            var email = document.getElementById("Staff_Email").value;
            var icNumber = document.getElementById("Staff_IC").value;
            var gender = document.getElementById("Staff_Gendar").value;
