                    ...
                    <div style="padding: 20px">
                        ...
                        <div class="container-M1" style="background-color: #C7DDFE;">
                            <diV style="background-color:#152C7C; color: white;">
                                <h3 class = "pt-2 pb-2 align-middle" style="padding-left: 12px;">Edit User Profile</h3> <!--Content Header-->
                            </div>
...
<div class="card h-100">
	<div class="card-body">
		<div class="row gutters">
			...
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div class="form-group">
					...
					<input type="number" class="form-control" id="UserIC" placeholder="Enter IC number" style="border-radius: 5px;  height:43px ;">
		...
		<div class="row gutters">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <a href="<?= BASEURL ?>/Admin" class="btn btn-secondary" style="position: relative; bottom: 20px; left: 140px;">Cancel</a>
					<button type="button" id="update-button" name="submit" class="btn btn-primary" style=" position:relative; bottom :20px;  position:relative; left:150px;">Update</button>
				</div>
			</div>
		</div>
	</div>
  ...
  updateButton.addEventListener("click", function() {
    ...
    var career = document.getElementById("website").value;
    var gender = document.getElementById("User_Gendar").value;
    var status = document.getElementById("Street").value;
    var citizenship = document.getElementById("ciTy").value;
    var birthDate = document.getElementById("User_BirthDate").value;
    var race = document.getElementById("zIp").value;
